    ...
    @auth   
        ...
        <header class="p-3 border-b bg-indigo-900 text-white shadow ">
            <div class="container mx-auto flex justify-center items-center">
                    ...
                    <a href="" class="flex items-center gap-2  p-2 text-white text-sm font-bold cursor-pointer mr-4  hover:border-b-4 hover:-translate-y-1 hover:scale-108 duration-300">
