        ...
        <table class="table-auto ">
            <thead>
                <tr class="bg-indigo-300 text-black">
                    ...
                    <th class="px-4 py-4 border border-blue-400">Razón Social</th>
            ...
            <tbody>
                ...
                @if($emisoras->isEmpty())
                    <tr class="text-center">
                        <td colspan="6" class="px-4 py-2 border border-blue-300 text-center text-gray-500">Aún no hay empresas emisoras que mostrar.</td>
                    </tr>
                @else
                    @foreach($emisoras as $emisora)
                    <tr class="text-center">
                        <td class="px-4 py-2 border border-blue-300">{{ $emisora->id }}</td>
